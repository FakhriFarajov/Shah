...
namespace ShahBuyerAuthApi.Infrastructure.Migrations
{
    ...
    [Migration("20251015165925_FixAddressWarehouseKeyLength")]
    partial class FixAddressWarehouseKeyLength
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ShahBuyerAuthApi.Core.Models.AdminProfile", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(36)
                        .HasColumnType("nvarchar(36)");
            ...
            modelBuilder.Entity("ShahBuyerAuthApi.Core.Models.BlacklistedToken", b =>
                {
                    b.Property<string>("Id")
            ...
            modelBuilder.Entity("ShahBuyerAuthApi.Core.Models.CountryCode", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ShahBuyerAuthApi.Core.Models.Tax", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ShahBuyerAuthApi.Core.Models.Address", b =>
                {
                    b.HasOne("ShahBuyerAuthApi.Core.Models.CountryCode", "Country")
                        .WithMany("Addresses")
            ...
            modelBuilder.Entity("ShahBuyerAuthApi.Core.Models.AdminProfile", b =>
                {
                    b.HasOne("ShahBuyerAuthApi.Core.Models.User", "User")
                        ...
                        .HasForeignKey("ShahBuyerAuthApi.Core.Models.AdminProfile", "UserId")
            ...
            modelBuilder.Entity("ShahBuyerAuthApi.Core.Models.Receipt", b =>
                {
                    b.HasOne("ShahBuyerAuthApi.Core.Models.Order", "Order")
                        .WithOne("Receipt")
                        .HasForeignKey("ShahBuyerAuthApi.Core.Models.Receipt", "OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ShahBuyerAuthApi.Core.Models.SellerProfile", b =>
                {
                    b.HasOne("ShahBuyerAuthApi.Core.Models.User", "User")
                        ...
                        .HasForeignKey("ShahBuyerAuthApi.Core.Models.SellerProfile", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ShahBuyerAuthApi.Core.Models.SellerTaxInfo", b =>
                {
                    b.HasOne("ShahBuyerAuthApi.Core.Models.SellerProfile", "SellerProfile")
                        ...
                        .HasForeignKey("ShahBuyerAuthApi.Core.Models.SellerTaxInfo", "SellerProfileId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("ShahBuyerAuthApi.Core.Models.Tax", "Tax")
            ...
            modelBuilder.Entity("ShahBuyerAuthApi.Core.Models.StoreInfo", b =>
                {
                    ...
                    b.HasOne("ShahBuyerAuthApi.Core.Models.SellerProfile", "SellerProfile")
                        .WithOne("StoreInfo")
                        .HasForeignKey("ShahBuyerAuthApi.Core.Models.StoreInfo", "SellerProfileId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ShahBuyerAuthApi.Core.Models.User", b =>
                {
                    b.HasOne("ShahBuyerAuthApi.Core.Models.CountryCode", "CountryCitizenship")
                        .WithMany("Users")
