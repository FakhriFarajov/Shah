...
{
    /// <inheritdoc />
    public partial class AddPassportToSellerProfile : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CountryCitizen = table.Column<int>(type: "int", nullable: false),
                    StoreInfoId = table.Column<string>(type: "nvarchar(36)", maxLength: 36, nullable: false),
                    SellerTaxInfoId = table.Column<string>(type: "nvarchar(36)", maxLength: 36, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(36)", maxLength: 36, nullable: false),
                    SellerProfileId = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SellerTaxInfos_SellerProfiles_Id",
                        column: x => x.Id,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StoreInfos_SellerProfiles_Id",
                        column: x => x.Id,
                        principalTable: "SellerProfiles",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CategoryId = table.Column<string>(type: "nvarchar(36)", maxLength: 36, nullable: false),
                    StoreInfoId = table.Column<string>(type: "nvarchar(36)", maxLength: 36, nullable: true)
                },
                constraints: table =>
                {
