...
export default function OrdersPage() { // accept the id of the user as prop to filter orders
	// State for sorting, filtering, modal visibility, selected order, etc.
			...
			render: (_: any, row: Order) => (
				<div className="flex items-center gap-2">
					{row.orderItems.map((item) => (
						<div key={item.id} className="flex flex-col items-center mr-2">
